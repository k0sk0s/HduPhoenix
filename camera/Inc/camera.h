...
// #define MAT_WIDTH 448
// #define MAT_HEIGHT 336
// #define MAT_WIDTH 448
// #define MAT_HEIGHT 336
...
public:
       Mycamera();
       ~Mycamera();
       bool open(int Index);           //开启相机，设置相机参数，创建句柄
  ...
  /* 
      ...
      bool   setVideoHeight(int y);

      bool   setVideoWidth(int x);
  ...
  // bool setVideoFdormat();//
       bool setVideoparam(int x ,int y);
  /* 
        Biref：设置相机参数
         */
      bool startStream(); //取流
